...
import { generateModeQuestions } from '../../utils/massQuestionBank.js';
    ...
    <div className="play-screen">
      ...
      <div className="world-grid">
        {WORLDS.map(world => {
          ...
          const stars = calcStars(prog.correct ?? 0, prog.total ?? 1);
          return (
...
export default function PlayPhase({ onComplete, playNarration }) {
  ...
  const handleModeSelect  = m  => {
    setSelectedMode(m);
    setQuestions(generateModeQuestions(selectedWorld.id, m.questionCount, { excludeLevel3: m.id==='guided' }));
    setScreen('playing');
  };
